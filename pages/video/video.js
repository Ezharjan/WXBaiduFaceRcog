...
Page({
  ...
  onLoad() {
    ...
    // 每次更新access_token
    wx.request({
      url: "https://aip.baidubce.com/oauth/2.0/token?grant_type=client_credentials&client_id=AhUkYqDg425KBd2kqlbY989F&client_secret=IfG6Kl1eSXVXcXO5inTse0XoEbKMqCP8",
      method: 'POST',
      dataType: "json",
      header: {
